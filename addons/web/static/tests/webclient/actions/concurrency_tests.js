...
QUnit.module("ActionManager", (hooks) => {
    ...
    QUnit.test(
        "execute a new action while loading a lazy-loaded controllers",
    ...
    QUnit.test(
        "execute a new action while switching to another controllers",
        async function (assert) {
            assert.expect(16);
    ...
    QUnit.test("restoring a controllers when doing an action -- load_action slow", async function (assert) {
        assert.expect(14);
        let def;
