...
var BasicController = AbstractController.extend(FieldManagerMixin, {
    ...
    init: function (parent, model, renderer, params) {
        ...
        // In this controllers, '_applyChanges' is overridden s.t. '_notifyChanges'
     ...
     *    controllers, but not yet sent to the model because of the mutex),
    ...
    /**
     * Called when the user clicks on the 'content' part of the controllers
